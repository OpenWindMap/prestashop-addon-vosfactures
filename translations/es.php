...
'Código API'; #api_token_label
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_e91d4304ab0cb2e7b6c315765a8338b3'] = ''.
'Choose if invoices should be emailed to client from VosFactures'; #auto_send_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_81d7a0e2580cf11a1d3bff6268c2c1e0'] = ''.
'Choose "never" if you need to configure your VosFactures account (invoice format, numberin'.
'g ...) before activating automatic invoice creation'; #auto_issue_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_3f2b903707d59df6d1993d51bbae1338'] = ''.
'API token with prefix (from your VosFactures account: Settings > Account settings > Integr'.
'ation)'; #api_token_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_3ebb01a06a924554fe7b366fe5e76f19'] = ''.
'Este módulo requiere la versión 1.5 (o más nueva) de PrestaShop'; #incompatible_version
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_f6d298461123eeef83830b5e85599ea6'] = ''.
'Hay que rellenar el campo "API Token" en los ajustes del módulo'; #empty_configuration_warning
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_a8f8c38878cc1ba8ac6d4a44c6f4606a'] = ''.
'La sobrecarga de clases está desactivada. Actívala para activar el módulo. Activa la sobre'.
'carga de clases en "Parámetros avanzados -> Rendimiento -> Modo depuración -> Inhabilitar '.
'las sobre-cargas -> NO"'; #overriding_is_disabled
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_31afa7c34609650c0a2e38fafaa97e86'] = ''.
'Invoices are currently disabled. In order for this module to work correctly, we require yo'.
'u to turn on Enable invoices at: Orders -> Invoices -> Enable invoices.'; #invoices_are_disabled
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_c3c1fc415f6f9ee1a934879298f6c0f1'] = ''.
'Ajustes de conexión'; #connection_settings
...
'You can create several departments on your VosFactures account to distinguish Prestashop s'.
'ales from other sales'; #department_hint
...
'Assign a category to Prestashop invoices to better distinguish them from other invoices'; #category_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_c924f9dbe3b7fe861d0615135d87c8ac'] = ''; #department_desc
...
'Incluir en factura el envío gratuito'; #include_free_shipment
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_44468fdad40969178349e8eda4419f67'] = ''.
'Choose to display free delivery costs on invoices'; #include_free_shipment_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_32a8d881fcf10d67239f168c86fa5da6'] = ''.
'Include delivery date on invoice'; #include_delivery_date
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_cee7b4183eadda1c2d2c74b86fa7c858'] = ''.
'Note that the Delivery Date will be recorded as an Additional Date on Your Invoices. Make '.
'sure to indicate "Delivery date" at the top of the list from your Settings > Account setti'.
'ngs > Configuration > "Options to change the time of sales" so that it is taken into accou'.
'nt by default.'; #include_delivery_date_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_bd6848ff76027d6010bdd8ce1e61078e'] = ''.
'Show order private comment on invoice'; #include_private_note
...
'Copiar el contenido por defecto en el campo “Comentarios” en factura'; #fill_default_descriptions
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_c97803911fb3ec29267336d38addef25'] = ''.
'The default “Notes" entered in your VosFactures account can be displayed on invoices'; #fill_default_descriptions_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_6dd81e1c309368cd1e11b7e8fa0f7220'] = ''.
'Use carrier name in invoices'; #use_carrier_name_label
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_9d92ad8c4ee3fc2aca94181dbf7c0b13'] = ''.
'You can replace the name "Delivery costs" by the carrier’s name'; #use_carrier_name_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_518aafa9004ff63a675df9a144bc20ef'] = ''.
'Override default carrier name used in invoices'; #override_carrier_name_label
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_365dcfebd0c3052e9d7b08001765089e'] = ''.
'Leave this field blank if you want to use default value.'; #override_carrier_name_hint
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_2265238c627a6ebe508b807fa5e8136c'] = ''.
'Buyer name on invoice'; #company_or_full_name_label
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_d3813241ed57f73f6509f4bb43cc1475'] = ''.
'The module will prefer chosen option when issuing the invoice'; #company_or_full_name_hint
...
'There were problems when issuing invoices for the following orders:'; #invoices_with_errors_notice
...
'Show order messages'; #show_order_messages
...
'Force invoicing with buyer VAT'; #force_vat
...
'Show on invoice product description from VF'; #prod_desc_from_vf
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_3233276034ff6b8bb61e2cafa2118bcf'] = ''.
'Download products in CSV'; #update_shop_uuid
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_0f7431650cc1691fbe92dc2cbb70e476'] = ''.
'Integra PrestaShop con tu cuenta de VosFactures'; #description_short
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_945670cf60281694da8858bc39ac6ccf'] = ''.
'Facturas emitidas en PrestaShop se emitirán automáticamente también en tu cuenta de VosFac'.
'tures. En PrestaShop solamente cambia el aspecto de facturas, el proceso de su generación '.
'es el mismo.'; #description_long
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_8b0c1b86678aa862a95051e405276da5'] = ''.
'Vosfactures.fr failed to return a response to the request. We believe that it\'s our issue'.
' and we\'ll do whatever we can to speed up the process. Please, try again later'; #firmlet_is_down
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_805c9aaea9e5c95031c5e787c18dbf79'] = ''.
'La prueba2 de conexión (verificación de los datos de la empresa) fallida. Por favor rellen'.
'a los datos de tu empresa en tu cuenta de VosFactures'; #connection_test2_failed
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_8493b1de591a1b5710872dad3292fcd9'] = ''.
'Si todavía no tienes cuenta de VosFactures:'; #new_account_info
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_7784322ba7f0e0c17938c5696fb4221b'] = ''.
'Mostrar la factura en VosFactures'; #show_invoice_on_account
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_4992438869633fb30ced0906855acb8b'] = ''.
'Envío automático de documento por email desde VosFactures'; #auto_send_label
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_b644fad46b034afe75e3b05eface832b'] = ''.
'Emitir automáticamente un documento en VosFactures'; #auto_issue_label
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_b436ffdf4e7a16531536eefc825583c7'] = ''.
'Eliminar la factura de VosFactures'; #remove_invoice
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_164059dd5d11b836285126058cd13c10'] = ''.
'Emitir una factura en VosFactures'; #issue_invoice
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_56e188966e5dbd65c3d7c4be6e44226b'] = ''.
'¿Estás seguro de que quieres eliminar el documento de VosFactures? ¡Es un proceso irrevers'.
'ible!'; #confirm_remove_invoice
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_0a5cff9c1645b33761cc4f04883e5c40'] = ''.
'Emitir una nota de abono en VosFactures'; #issue_correction_invoice
$_MODULE['<{vosfacturesapp}prestashop>vosfacturesapp_41a357b3dd226f54a30ced4a958c58bc'] = ''.
'Tu cuenta de VosFactures no tiene el plan PRO activado'; #account_not_pro
