 ...
 * @since 2.4.14
 */
function upgrade_module_2_4_14($object)
{
    ...
    $success = $object->removeOverride('Order') &&
        ...
        Configuration::updateValue(Tools::strtoupper('VOSFACTURES_' . 'version'), '2.4.14');

    $object->addLog(sprintf('Upgrade from %s to 2.4.14r: %s', $firmlet_version, $success ? 'success' : 'failure'));
