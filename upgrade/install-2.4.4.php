 ...
 * @since 2.4.4
 */
function upgrade_module_2_4_4($object)
{
    ...
    $success = $object->removeOverride('Order') &&
        ...
        Configuration::updateValue(Tools::strtoupper('VOSFACTURES_' . 'version'), '2.4.4');

    $object->addLog(sprintf('Upgrade from %s to 2.4.4: %s', $firmlet_version, $success ? 'success' : 'failure'));
