...
function upgrade_module_2_4_9($object)
{
    ...
    $success = $object->removeOverride('Order') &&
        ...
        Configuration::updateValue(Tools::strtoupper('VOSFACTURES_' . 'version'), '2.4.9');

    $object->addLog(sprintf('Upgrade from %s to 2.4.9: %s', $firmlet_version, $success ? 'success' : 'failure'));
