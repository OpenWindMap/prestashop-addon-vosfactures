 ...
 * @since 2.4.12
 */
function upgrade_module_2_4_12($object)
{
    ...
    $success = $object->removeOverride('Order') &&
        ...
        Configuration::updateValue(Tools::strtoupper('VOSFACTURES_' . 'version'), '2.4.12');

    $object->addLog(sprintf('Upgrade from %s to 2.4.12r: %s', $firmlet_version, $success ? 'success' : 'failure'));
